...
def category_index(request):
    ...
    return render(request, 'category_index.html', {'all_categories': all_categories})
...
def category_details(request, c_slug):
    ...
    return render(request, 'category_details.html', {'category': category, 'all_products': all_products})
